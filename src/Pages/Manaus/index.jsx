                        ...
                        <div className="site-card-border-less-wrapper">
                            <li>
...

                                    {
                                        AllData[0] && (
                                            <ul id='text-dbpecas'>
                                                ...
                                                <li>{AllData[1].agencia}</li>
                                                <li>{AllData[1].cc}</li>
                                                <li>{AllData[1].cnpj}</li>
                                                <li>{AllData[1].nome}</li>
                                                <li>{AllData[1].pix}</li>
                                                <li>{AllData[1].site}</li>
                                            </ul>)}
                                ...
                                >
                                    ...
                                    {AllData[2] && (
                                        <ul id='text-endereco'>
                                            <li>{AllData[4].adressEscritorioAm} </li>
                                            <li>{AllData[4].cepEscritorioAm} </li>
                                            <li>{AllData[4].adressChillerAm} </li>
                                            <li>{AllData[4].cepChillerAm} </li>
                                        </ul>
                                    )}
                                    {!AllData[0] && (
                                        <div>
                                ...
                                <Card className='card' title="Dados juridicos"
                                    ...
                                    {AllData[2] && (
                                        <ul id='text-juridico'>
                                            <li>{AllData[5].cnpjChillerAm} </li>
                                            <li>{AllData[5].ieChillerAm} </li>
                                            <li>{AllData[5].imChillerAm} </li>
                                            <li>{AllData[5].cpfRicardo}</li>
                                            <li>{AllData[5].rgRicardo}</li>
                                        </ul>
                                    )}
                                    {!AllData[0] && (
                                        <div>
